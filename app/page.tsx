...
const TERM_LINES = [
  ...
  { t: 'pass',     s: '  [✓] 64-bit Value Model  U64/I64 preserved in r0:r1 pair (QEMU)' },
  ...
  { t: 'dim',      s: '  ──────────────────────────────────────────' },
  { t: 'key',      s: '  Total: 0.037ms  (39 manifests · 442,738 aet bytes · 134 ops)' },
  { t: 'dim',      s: '' },
...
const MANIFESTS: [string, string, ('declared')?][] = [
  ...
  ['correctness_certificate', 'Track TT · self-consistent · tamper-evident'],
        ...
        <div className="hero-left">
          ...
          <div className="hero-stats">
            ...
            <div className="stat-cell">
              ...
              <span className="stat-lbl">avg / op</span>
            </div>
          </div>
