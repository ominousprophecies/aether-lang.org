...
<span className="footer-copy" style={{whiteSpace:'nowrap',fontSize:'clamp(6px,0.80vw,10px)'}}>© 2026 Emilio R. Bruno · Aether-Lang.org Inc. (CBCA federal) · Kamloops, BC, Canada · Four US provisional patents filed with the USPTO (July 2026); CA in preparation · AI assistance (Claude/Anthropic) disclosed · Page updated 2026-09-17</span>      </footer>
    </>
  )
}
