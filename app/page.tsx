  ...
  return (
    <>
      ...
      <section id="standards" style={{maxWidth:'none'}}>
        ...
        <p className="section-sub" style={{maxWidth:'none',columnWidth:'340px',columnGap:'2.75rem'}}>Aether's manifests reference the certification frameworks used across NATO member nations and major regulatory jurisdictions. These references are compile-time evidence — Aether has not been qualified or certified under these standards, and manifest emission is not a substitute for tool qualification (e.g. DO-330, ISO 26262).</p>
